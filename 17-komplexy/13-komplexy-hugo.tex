...
\author{\includegraphics[keepaspectratio,width=4cm]{img/cisplatin.png}}
\date{}
...
\ce{[Co(NH3)5Br]SO4} & síran pentaammin-bromidokobaltitý  \\
\end{tabular}
\vspace{1cm}
\\
...
\vspace{1cm}
\begin{tabular}{ll}
\ce{[Pt(NH3)4][CuCl4]} & tetrachloridoměďnatan tetramminplatnatý \\
\ce{[Cu(NH3)4][PtCl4]} & tetrachloridoplatnatan tetraamminměďnatý \\
\end{tabular}
}
...
\frame{
	\frametitle{}
	\begin{figure}
			\includegraphics[height=.8\textheight]{../01-nazvoslovi/kmplx-izomery.png}
	\end{figure}
}
