...
\begin{tabular}{|c|l|}
	...
	\hline
	\textbf{II} & \ce{CaO}, \ce{MnCl2}, \ce{FeBr2}, \ce{CaSO4}, \ce{NiCl2}, \ce{BaO2}  \\\hline
	\hline
...
Příklady iontů: \ce{Na+}, \ce{Al^{3+}}, \ce{Mn^{4+}}, \ce{Hg^{2+}}, \ce{Hg$_2^{2+}$}, \ce{Cl-}, \ce{ClO-}, \ce{ClO$_3^{-}$}
...
Ionty odvozené od amoniaku: \ce{NH3}, \ce{NH$_4^+$}, \ce{NH$_2^-$}, \ce{NH$^{2-}$}, \ce{N$^{3-}$} a azoimidu, \ce{N$_3^-$}. Pyridinium, anilinium, acetacidium, methylammonium, fenylammonium.

\subsection{Podvojné soli}

Ve vzorcích podvojných solí se kationty uvádějí v pořadí rostoucích oxidačních čísel, v případě stejného oxidačního čísla v abecedním pořadí (uvažujeme značky prvků). \textit{Víceatomové kationty}, např. \ce{NH$_4^+$} nebo \ce{PH$_4^+$} se uvádějí poslední ve skupině kationtů stejného náboje. V názvu se oddělují pomlčkou a pořadí je dáno pořadím ve vzorci.
...
\begin{tabular}{|l|l|}
	...
	\ce{KAl(SO4)2.12H2O} & dodekahydrát síranu draselno-hlinitého \\\hline
	\ce{NaNbO3} & oxid sodno-niobičný (trioxid) \\\hline
	\ce{KCr(SO4)2.12H2O} & dodekahydrát síranu draselno-chromitého \\\hline
	\ce{LiFePO4} & fosforečnan lithno-železnatý \\\hline
	\ce{CaMg(CO3)2} & uhličitan vápenato-hořečnatý \\\hline
	\ce{CuFeS2} & sulfid měďnato-železnatý \\\hline
	\ce{NaMgF3} & fluorid sodno-hořečnatý \\\hline
	\ce{BaTiO3} & oxid barnato-titaničitý \\\hline
\end{tabular}
...
\begin{tabular}{|l|l|}
	...
	\ce{PbBrCl} & bromid-chlorid olovnatý \\\hline
	\ce{LaOCl} & chlorid-oxid lanthanitý \\\hline
\end{tabular}
...
\begin{figure}[h]
	\adjincludegraphics[width=\textwidth]{img/nazvoslovi-polyionty.png}
\end{figure}
...
\ce{SO2(NH2)2}, \ce{SO(NH2)}, \ce{CO(NH2)2} (močovina), \ce{OP(OEt)3}, ethylester kyseliny octové, kyselina nitrido-tris(sírová) \ce{N(SO3H)3}
