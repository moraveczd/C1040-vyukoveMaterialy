...
\zadani{Vypočítejte koncentraci iontů v nasyceném roztoku \ce{Ag2CrO4}}

Chroman stříbrný v roztoku disociuje podle rovnice:

\ce{Ag2CrO4 <=> 2 Ag+ + CrO$^{2-}_4$}

Součin rozpustnosti vypočítáme:

$K_S = 10^{-11,61} = 2,45\times 10^{-12}\\
K_S = [\ce{Ag+}]^2[\ce{CrO$^{2-}_4$}] = 4x^3\\
x = \sqrt[3]{\frac{K_S}{4}} = \sqrt[3]{6,137\times 10^{-13}} = 8,50\times 10^{-5}$ M CrO$^{2-}_4$\\
$[Ag^+] = 2x = 1,70\times10^{-4}$ M

\textbf{Ukázat video}\footnotemark \footnotetext{\href{https://commons.wikimedia.org/wiki/File:Argentometric_titration.webm}{Argentometric titration}}

\odpoved{Koncentrace stříbrného iontu je 1,70$\times10^{-4}$ a chromanového je 8,50$\times$10$^{-5}$ mol.dm$^{-3}$}
