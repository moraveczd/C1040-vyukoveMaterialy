...
$w_0 = \frac{45,88}{148,88} = 0,3145\\
w_{60} = \frac{28,14}{128,14} = 0,2196\\
...
K_S = [\ce{Sn^{4+}}][\ce{OH-}]^4 = x \times (4x)^4 = 256x^4\\
x = \sqrt[4]{\frac{K_S}{256}} = \sqrt[4]{\frac{1 \times 10^{-56}}{256}} = 2,5\times 10^{-15}$ M = c(\ce{Sn^{4+}})

c(\ce{OH^{-}}) = 4 $\times\ 2,5\times10^{-15}$ = 1$\times10^{-14}$ M

\odpoved{Koncentrace cíničitých iontů je 2,5$\times10^{-15}$ mol.dm$^{-3}$ a hydroxidových iontů je 1$\times$10$^{-14}$ mol.dm$^{-3}$.}
