...
\begin{itemize}
	...
	\item 1 mol ideálního plynu má objem 22,414 dm$^3$ \\ (molární objem $V_m$, T = 273,15 K, p = 101 325 Pa)
...
\subsection{Standardní podmínky}

\begin{itemize}
	\item IUPAC definuje standardní podmínky pro plyny:
	\begin{itemize}
...
\clearpage
\subsection{Molární objem}
\begin{itemize}
	\item Objem jednoho molu plynu.
	\item Lze jej vypočítat ze stavové rovnice ideálního plynu:
	\item T = 273,15 K; p = 101 325 Pa
	\item $\textrm{V}\ =\ \frac{\textrm{nRT}}{\textrm{p}}\ =\ \frac{1\ .\ 8,314\ .\ 273,15}{101 325}\ =\ 0,022414\ \textrm{m}^3$
	\item T = 273,15 K; p = 100 000 Pa
	\item $\textrm{V}\ =\ \frac{\textrm{nRT}}{\textrm{p}}\ =\ \frac{1\ .\ 8,314\ .\ 273,15}{100 000}\ =\ 0,022710\ \textrm{m}^3$
\end{itemize}

\subsection{Boyleův zákon}
\begin{itemize}
