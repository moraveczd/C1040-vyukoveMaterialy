...
\begin{itemize}
	...
	\item \textbf{Přenasycený roztok} -- koncentrace látky je vyšší, než její rozpustnost za dané teploty.
\end{itemize}
...
\odpoved{Koncetrace stříbrného a chloridového iontu jsou 1,33$\times$10$^{-5}$ mol.dm$^{-3}$}
